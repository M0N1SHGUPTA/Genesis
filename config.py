...
STAT_NUMBER_SIZE = Pt(52)       # the big number in a key_stats layout (large for visual dominance)
...
COLOR_TEXT_SECONDARY = RGBColor(0x44, 0x44, 0x44)  # dark gray — body/description text (higher contrast than muted)
